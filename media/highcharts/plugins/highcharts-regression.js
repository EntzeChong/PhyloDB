    ...
    H.wrap(H.Chart.prototype, 'init', function (proceed) {
        ...
        for (i = 0 ; i < series.length ; i++){
            ...
            if ( s.regression && !s.rendered ) {
                ...
                regression.rSquared =  coefficientOfDetermination(s.data, regression.points).toFixed(3);
...
//        var string = 'y = ' + Math.round(gradient*100) / 100 + 'x + ' + Math.round(intercept*100) / 100;
        var int = intercept.toExponential(3);
        var slope = gradient.toExponential(3);
        var string = 'y = ' + slope + 'x + ' + int;
